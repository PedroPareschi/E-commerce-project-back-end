...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.dev.pedropareschi.cursomc.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "Esta API é um projeto para o curso de Spring Boot do prof. Nelio Alves",
                "Versão 1.0",
                "",
                new Contact("Pedro Pareschi", "https://github.com/PedroPareschi", "pedropareschi15@gmail.com"),
                "Permitido para todos os públicos",
                "",
